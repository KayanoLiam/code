...
3. **[变量和常量](Basics/Variables.md)** - 数据存储和可变性
...
9. **[枚举](Basics/Enums.md)** - 枚举类型和模式匹配
10. **[联合体](Basics/Unions.md)** - 联合体的使用

### 🔥 进阶阶段
11. **[编译时计算](Basics/Comptime.md)** - 强大的 comptime 系统
12. **[构建系统](Basics/build_system.md)** - Zig 的构建工具
13. **[注释和文档](Basics/Comments.md)** - 代码文档化
